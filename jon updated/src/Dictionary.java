...
public class Dictionary {
    ...
    /**
     * Set of words in user dictionary
     */
    public static HashSet<String> userDictionary = new HashSet<>();
     ...
     */
    public static boolean FindWord(String word){
        System.out.println(word + " from user dictionary" + userDictionary.contains(word));
     ...
     */
    public static void ResetDictionary(){
        System.out.println("reset dictionary caleld");
        userDictionary.clear();
    ...
    public static void StartDictionary(boolean useGlobalDictionary) throws FileNotFoundException {

        System.out.println("start dict called");
    ...
    else
    {
        ...
        // user dictionary
        try{
           InputStream is = new FileInputStream("dictionary/userDict.txt");
           BufferedReader br = new BufferedReader(new InputStreamReader(is));
    ...
    public static void SetUserDictionary(String[] words){
        userDictionary.clear();
        userDictionary.addAll(Arrays.asList(words));
    ...
    public static void main(String[] args) throws FileNotFoundException, RuntimeException {
        ...
        // Assert(FindWord("thisIsFirst"));
        // System.out.println("error removing from user didssadsactionary");
        // Assert(FindWord("thisIsNotFirst"));
        // Assert(FindWord("thisIsSecond"));
